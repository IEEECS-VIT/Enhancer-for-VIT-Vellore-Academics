...
const modifyInternalMarksPage = () => {
  ...
  jQuery(".customTable-level1 > tbody")
    .map(function () {
      var totalClassWeightage = 0,
      ...
      this.innerHTML +=
        ...
        `</td>
            <td></td>
            <td>` +
        totalScoredMark.toFixed(2) +
        `</td>
            <td style='font-weight: 700' >` +
        totalUserWeightage.toFixed(2) +
        `</td>
            <td>` +
        totalClassAverage.toFixed(2) +
        `</td>
            <td style='font-weight: 700' >` +
        totalClassWeightage.toFixed(2) +
        `</td>
            <td></td>
            <td></td>
        </tr>`;
